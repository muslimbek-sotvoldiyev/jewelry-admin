...
export default function NotificationsPage() {
  ...
  const getPriorityBadge = (priority: string) => {
    switch (priority) {
      ...
      case "medium":
        return <Badge className="bg-yellow-100 text-yellow-800 hover:bg-yellow-100">{t("priority.medium")}</Badge>
      case "low":
        return <Badge variant="secondary">{t("priority.low")}</Badge>
      default:
        return <Badge variant="secondary">{t("priority.unknown")}</Badge>
    }
  }
  ...
  return (
    <div className="flex-1 space-y-6 p-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            {t("subtitle")} {unreadCount > 0 && t("unreadCount", { count: unreadCount })}
          </p>
        </div>
      ...
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">{t("stats.highPriority")}</CardTitle>
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <Select value={typeFilter} onValueChange={setTypeFilter}>
              ...
              <SelectContent>
                ...
                <SelectItem value="transfer_pending">{t("types.transferPending")}</SelectItem>
                <SelectItem value="transfer_confirmed">{t("types.transferConfirmed")}</SelectItem>
                <SelectItem value="workshop_timeout">{t("types.workshopTimeout")}</SelectItem>
                <SelectItem value="material_loss">{t("types.materialLoss")}</SelectItem>
                <SelectItem value="workshop_status">{t("types.workshopStatus")}</SelectItem>
              </SelectContent>
            </Select>
