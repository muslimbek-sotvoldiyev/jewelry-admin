...
const store = configureStore({
  ...
  middleware: (getDefaultMiddleware) =>
    getDefaultMiddleware().concat(api.middleware, AuthApi.middleware, AtolyeApi.middleware, UsersApi.middleware, MaterialsApi.middleware, InventoryApi.middleware),
});
