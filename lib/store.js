...
const store = configureStore({
  ...
  middleware: (getDefaultMiddleware) =>
    getDefaultMiddleware().concat(AuthApi.middleware, AtolyeApi.middleware, UsersApi.middleware, MaterialsApi.middleware, InventoryApi.middleware, TransactionsApi.middleware),
});
