  ...
  return (
    <div className="flex-1 space-y-6 p-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-balance">Bosh sahifa</h1>
          <p className="text-muted-foreground">Zargarlik korxonasi boshqaruv paneli</p>
        </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Jami materiallar</CardTitle>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">tasdiqlash kutilmoqda</p>
          </CardContent>
        </Card>
      </div>
